...
Проект реализован с нуля для задания 3 «Мини-продукт с LLM-аналитикой».

## Текущий статус

- Frontend опубликован: [https://linsivs.github.io/llm-agent/](https://linsivs.github.io/llm-agent/)
- Репозиторий: [https://github.com/linsivs/llm-agent](https://github.com/linsivs/llm-agent)
- Демо-отчет работает без backend по кнопке «Показать демо».
- Для анализа пользовательских файлов необходимо один раз создать Render-сервис из `render.yaml` и добавить новые API-ключи.
...
| Интерфейс | Next.js, drag-and-drop, отчет и журнал |
...
Команда запускает ESLint, TypeScript, 16 тестов и production build.
...
4. Для мобильного скрина используйте ширину 390 px в DevTools.
